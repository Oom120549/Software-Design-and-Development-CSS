...
```css
nav {
    background-color: rgb(87, 196, 250);
    padding: 20px;
}
...
```
![image](https://github.com/user-attachments/assets/86540520-e2e2-4aae-90dc-493eca355b44)
...
<body>
    <div class="stats-container">
        <div class="stat-box">
            <div class="stat-number">69,000</div>
            <div class="stat-label">ผู้ใช้งาน</div>
        </div>
        <div class="stat-box">
...
```
![image](https://github.com/user-attachments/assets/8ec94364-3b5f-42f7-8a9e-03e8c4a4a702)
...
<body>
    <article class="blog-post">
        <header class="post-header">
            <h1 class="post-title">วิธีการเขียนบทความที่น่าสนใจ</h1>
            <div class="post-meta">โพสต์เมื่อ 12 กุมภาพัน 2025 | โดย ผู้เขียน นายกิตติภัค เกตุแก้ว</div>
        </header>
        
        <div class="post-content">
            <p>เนื้อหาบทความที่ดีควรมีความน่าสนใจและเป็นประโยชน์ต่อผู้อ่าน การเขียนบทความให้น่าอ่านนั้นมีหลักการสำคัญหลายประการ</p>

            <h3>1. การเลือกหัวข้อที่น่าสนใจ</h3>
            <p>หัวข้อที่ดีควรตรงกับความสนใจของกลุ่มเป้าหมาย และมีประโยชน์ต่อผู้อ่าน</p>
...
```
![image](https://github.com/user-attachments/assets/458d0b30-8628-4e62-a184-bffb3bfab6c1)
...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="Modern Dashboard.css">
</head>
<body>
    <div class="dashboard">
        <header class="header">
...
```
![image](https://github.com/user-attachments/assets/461731c2-62e7-4179-a777-ba58db081014)
